...
# Función para obtener predicciones para un día dado
def predict_meal(day_input):
...
predictions = predict_meal(day_input)

if predictions is not None:
    print(f"Predicciones enteras para el día {day_input}: {predictions}")
